...
from rendering import render, load_image, render_m_test
...
class Validation:
    ...
    def validate_m_test(self, obj_file_path: str, preview_file_path: str, prompt: str):
        try:
            start = time.time()
            # print("Rendering 3D mesh file.....")    
            rendered_images, before_images, render_image_paths = render_m_test(obj_file_path)
            ...
            prev_img_path = preview_file_path
